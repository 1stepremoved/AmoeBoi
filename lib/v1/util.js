...
export const aabbCheck = (amoeba1, amoeba2) => {
  if (amoeba2.xpos + amoeba2.radius + amoeba1.radius > amoeba1.xpos
    ...
    collision(amoeba1, amoeba2);
  }
};

const collision = (amoeba1, amoeba2) => {
  ...
  if (distance > currentDistance) {
    ...
    amoeba1.nextMomentum['x'] += boundNum(amoeba2.momentum['x']
        * amoeba2.mass * (currentDistance / distance) * amoeba1.timeVars.timeCoefficient, -50, 50);
    ...
    amoeba2.nextMomentum['x'] += boundNum(amoeba1.momentum['x']
        * amoeba1.mass * (currentDistance / distance) * amoeba1.timeVars.timeCoefficient, -50, 50);
    ...
    if (amoeba1.mass <= amoeba2.mass) {
      applyCollisionPhysics(amoeba2, amoeba1, currentDistance);
    } else {
      applyCollisionPhysics(amoeba1, amoeba2, currentDistance);
    }
  }
};

const applyCollisionPhysics = (bigAmoeba, smallAmoeba, currentDistance) => {
  ...
  let bubble = smallAmoeba.massDelta * smallAmoeba.mass
      ...
      * boundNum(bigAmoeba.timeVars.timeCoefficient, 0.5, 2);
