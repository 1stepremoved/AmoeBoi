...
class Game {
  ...
  animate = () => {
    ...
    if (this.paused) {
      this.amoebas.forEach(amoeba => {
        amoeba.draw(this.ctx, this.boardVars, this.mouseVars);
      });
      this.amoeboi.draw(this.ctx, this.boardVars, this.mouseVars);
  ...
  moveAmoebas = (ctx) => {
    ...
    this.amoeboi ? this.amoeboi.draw(this.ctx, this.boardVars, this.mouseVars) : null;
    ctx.globalAlpha = 1;
  ...
  makePause = (ctx) => {
    ...
    let mouseOffsetX = this.mouseVars.mousePos.x / window.innerWidth * 50;
    let mouseOffsetY = this.mouseVars.mousePos.y / window.innerHeight * 50;
