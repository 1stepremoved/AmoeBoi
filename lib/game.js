...
class Game {
  ...
  setupAmoebas(amoeboi) {
    ...
    QuadTree.prototype.realBoardWidth = this.boardVars.realBoardWidth;
    QuadTree.prototype.realBoardHeight = this.boardVars.realBoardHeight;
    ...
    for (let i = 0, num = parseInt(2 * this.boardSize); i < num; i++) {
      ...
      amoeba = new Amoeba(this.ctx, xpos, ypos, mass, momentum);
